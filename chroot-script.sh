...
su $user -c "cd && sudo pacman -S go && git clone https://aur.archlinux.org/yay.git && cd yay && makepkg -S && echo $userpw | sudo --stdin pacman -U --noconfirm && cd .. && rm -rf yay && sudo pacman -Rs go"
